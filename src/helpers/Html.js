...
import { googleAnalyticsCode } from 'helpers/analytics'
    ...
    return (
      <html lang='en-us'>
        ...
        <body>
          ...
          <script id='seed-data' dangerouslySetInnerHTML={{__html: `window.__data=${serialize(store.getState())};`}} charSet='UTF-8'/>
